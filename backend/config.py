...
# Risk Levels
RISK_LEVEL_1 = 'گروه ۱: ریسک پایین'
RISK_LEVEL_2 = 'گروه ۲: لبه خطر بلند مدت (ریسک مزمن سبک زندگی)'
RISK_LEVEL_3 = 'گروه ۳: لبه خطر کوتاه مدت (ریسک حاد بالقوه)'
RISK_LEVEL_CRITICAL = 'گروه ۴: ریسک بالینی اولویت‌دار (Critical Risk)'
