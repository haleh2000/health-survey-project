...
const SHARE_TEXT = "خلاصهٔ وضعیت سلامتم را در «دی‌دار» ببین — نقشه اندام‌ها، شاخص توده بدنی و پیشنهادهای سلامت.";
  ...
  return (
    <div data-pdf-exclude className="flex flex-col items-center gap-3">
      ...
      <p className="text-[11px] text-ink-subtle">
        فایل PDF شامل مشخصات، نقشه سلامت اندام‌ها، شاخص توده بدنی و متنِ کاملِ پیشنهادهای سلامت است.
      </p>
