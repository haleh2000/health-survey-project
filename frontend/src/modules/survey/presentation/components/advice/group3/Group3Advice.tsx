      ...
      <div className="rounded-2xl bg-white">
        ...
        <AdviceSectionCard title="ورزش" borderTitle="پیشنهادات کاهش وزن و ورزش" backgroundColor="bg-white">
          ...
          <SectionHeader
            ...
            titleColorClass="text-day-red"
            description="این سیستم ورزشی هوشمند با استفاده از روش علمی دوره بندی تمرین کمک می کند کاهش کالری باعث افت متابولیسم یا تحلیل عضلانی نشود.این روش در کنار رژیم غذایی سالم بهتر عمل می کند. هدف این برنامه در ۱۲ هفته کاملا حفظ حجم عضلانی و افزایش چربی سوزی است."
          />
