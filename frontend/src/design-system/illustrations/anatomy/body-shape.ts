...
function buildGeometry(metrics: Metrics): Geometry {
  ...
  const shoulder =
    (1 - 0.10 * childness) * sex(0.935) * (1 + 0.28 * growth(0.7) - 0.09 * thin);
  const neck =
    (0.45 * headWidth + 0.55 * shoulder) *
    sex(0.96) *
    (1 + 0.14 * growth(0.35) - 0.07 * thin);
  ...
  const knots: readonly (readonly [number, number])[] = [
    ...
    [REF.chest, (1 + 0.03 * childness) * sex(1.0) * (1 + 0.32 * growth(0.6) - 0.13 * thin)],
    [REF.waist, (1 + 0.05 * childness) * sex(0.93) * (1 + 0.48 * growth(0.45) - 0.18 * thin)],
    [285, (1 + 0.07 * childness) * sex(0.97) * (1 + 0.52 * growth(0.45) - 0.19 * thin)],
    [REF.hip, (1 + 0.02 * childness) * sex(1.075) * (1 + 0.40 * growth(0.5) - 0.16 * thin)],
    [400, (1 + 0.02 * childness) * sex(1.05) * (1 + 0.34 * growth(0.7) - 0.16 * thin)],
    [REF.knee, sex(1.0) * (1 + 0.22 * growth(0.8) - 0.10 * thin)],
    [510, sex(0.99) * (1 + 0.24 * growth(0.8) - 0.13 * thin)],
    [REF.ankle, sex(0.97) * (1 + 0.11 * growth(0.9) - 0.07 * thin)],
    [REF.sole, sex(0.95) * (1 + 0.09 * growth(1) - 0.06 * thin)],
  ];
