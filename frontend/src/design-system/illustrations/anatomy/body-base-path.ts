...
const ARM_LATERAL: readonly Pt[] = [
  [75.6, 128],
  [80.2, 141],   // برجستگیِ دلتوئید
  [80.8, 152],
  [83.1, 170],
  [84.4, 186],
  [85.1, 200],
  [86.2, 216],
  [87, 233],     // اپی‌کندیلِ بیرونیِ آرنج
  [90.2, 246],
  [93.3, 262],   // پهن‌ترین جای ساعد (براکیورادیالیس)
  [94.5, 276],
  [93.3, 290],
  [94.6, 306],
...
function handPoints(): Pt[] {
  const points: Pt[] = [
    ...
    [102, 337],
    [106.5, 347],
    [108.4, 355, 1],    // نوکِ شست (کوتاه‌تر از انگشتان و کمی بالاتر از مفصل)
    [105, 360],
    [101.6, 356],
    [98.6, 347, 0.2],  // گودیِ اولِ بین‌انگشتی
  ];
  ...
  points.push(
    [72.9, 360],   // لبهٔ داخلیِ کفِ دست (هیپوتنار)
    [73.4, 346],
    [76, 320],     // لبهٔ داخلیِ مچ
  );
